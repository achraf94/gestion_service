                ...
                <div style="height:250px;" class="col-xs-4 col-md-2  <?php echo $color; ?> w3-margin w3-border w3-round-xlarge">
                    <div class=" w3-center w3-padding">
                        ...
                        <div class="w3-center" title="action">
                            <button data-idenseignant="<?php echo $row["eid"]; ?>" data-annee="<?php echo $row["annee"]; ?>" class="w3-btn show-groups w3-circle btn-primary"> <i class="fas fa-layer-group w3-text-black"></i></button>
